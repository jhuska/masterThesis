...
\chapter{New approach}
  ...
  \begin{figure*}[h!]
    \begin{center}
    \leavevmode
    \centerline{\scalebox{1.0}{\includegraphics[width=0.9\textwidth]{figures/FirstTestsRunBMPN.png}}}
    \end{center}
...
the Web Manager, already described in section \ref{sec:whyWeChooseJCR}.
  ...
  \begin{figure*}[h!]
      \begin{center}
      \leavevmode
      \centerline{\scalebox{1.0}{\includegraphics[width=0.7\textwidth]{figures/chartComponentRenamed.png}}}
      \end{center}
  ...
  \begin{figure*}[h!]
      \begin{center}
      \leavevmode
      \centerline{\scalebox{1.0}{\includegraphics[width=0.9\textwidth]{figures/rchFacesVersionChanged.png}}}
      \end{center}
...
\begin{figure*}[!htb]
    \begin{center}
    \leavevmode
    \centerline{\scalebox{1.0}{\includegraphics[width=1.0\textwidth]{figures/testSuiteList.png}}}
    \end{center}
...
\begin{figure*}[!htb]
    \begin{center}
    \leavevmode
    \centerline{\scalebox{1.0}{\includegraphics[width=1.0\textwidth]{figures/testSuiteRunList.png}}}
    \end{center}
...
\begin{figure*}[!htb]
    \begin{center}
    \leavevmode
    \centerline{\scalebox{1.0}{\includegraphics[width=1.0\textwidth]{figures/testSuiteRunResults.png}}}
    \end{center}
...
\begin{figure*}[!htb]
    \begin{center}
    \leavevmode
    \centerline{\scalebox{1.0}{\includegraphics[width=1.0\textwidth]{figures/testSuiteListResponsive.png}}}
    \end{center}
...
\begin{figure*}[!htb]
    \begin{center}
    \leavevmode
    \centerline{\scalebox{1.0}{\includegraphics[width=1.0\textwidth]{figures/testSuiteRunResultsResponsive.png}}}
    \end{center}
