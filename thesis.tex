...
\chapter{Visual testing of software}    
  ...
  \end{enumerate}
    ...
    This is quite easily to be achieved, but still, a developer of a tool for visual testing should has this in mind beforehand. Todays CI systems support variety of build systems, for
